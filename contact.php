                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="input-box mt-25">
                                        ...
                                        <input type="text" placeholder="Golu">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="input-box mt-25">
                                        <label for="#">Email</label>
                                        <input type="email" placeholder="gole@gmail.com">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="input-box mt-25">
                                        <label for="#">Phone</label>
                                        <input type="text" placeholder="+91 8454..">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="input-box mt-25">
                                        <label for="#">Subject</label>
                                        <input type="text" placeholder="Add to my Restaurant">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="input-box mt-25">
                                        <label for="#">Subject</label>
                                        <textarea name="#" id="#" cols="30" rows="10" placeholder="Start write here your message"></textarea>
